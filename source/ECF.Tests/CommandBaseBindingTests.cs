...
public class CommandBaseBindingTests
{
    ...
    public void arguments_in_right_order()
    {
        ...
        Assert.True(command.Flag1);
        Assert.True(command.Flag2);
        Assert.False(command.Flag3); // flag3 is matched by 'f3' and not '-f3'
    }
    ...
    [InlineData("-p1 -p2", null, null, null, false, false, false, "-p2", null, null, false, false, false, null, null, null)]
